...
static struct Command commands[] = {
	...
	// This is the addition of the backtrace command
	{ "backtrace", "Display the backtrace of the current kernel stack", mon_backtrace },
};
...
mon_backtrace(int argc, char **argv, struct Trapframe *tf)
{
   ...
   cprintf("Stack backtrace:\n");
	...
	while (ebp) {														// Create a while loop to loop through ebp content
		...
		int i = 0;														// Create a counter and set it to 0
